...
export type ChallengeAcceptedHubModelNewsletterSignupBenefitsField = {
  __typename?: 'ChallengeAcceptedHubModelNewsletterSignupBenefitsField';
  blocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
};
...
export type ChallengeAcceptedHubRecord = RecordInterface & {
  ...
  newsletterSignupBenefits?: Maybe<ChallengeAcceptedHubModelNewsletterSignupBenefitsField>;
  newsletterSignupIntro?: Maybe<Scalars['String']['output']>;
